...
// refer to Module (if they choose; they can also define Module)
  ...
  Module['FS_createPath']('/', 'Zend', true, true);
   ...
   loadPackage({"files": [{"filename": "/Zend/bench.php", "start": 0, "end": 7634, "audio": 0}], "remote_package_size": 7634, "package_uuid": "ff2269ac-807f-4895-97cc-1e0426d7e5a1"});
...
var STATIC_BASE = 1024,
    ...
    STACKTOP = STACK_BASE,
    STACK_MAX = 7506784,
    DYNAMIC_BASE = 7506784,
    DYNAMICTOP_PTR = 2263712;
...
var ASM_CONSTS = [function($0) { const jsRet = String(eval(UTF8ToString($0))); const len = lengthBytesUTF8(jsRet) + 1; const strLoc = _malloc(len); stringToUTF8(jsRet, strLoc, len); return strLoc; },
 ...
 function($0, $1) { console.log($0, $1) },
 function($0, $1) { const timeout = Number(UTF8ToString($0)); const funcPtr = $1; setTimeout(()=>{ console.log(timeout, funcPtr); Module.ccall( 'exec_callback' , 'number' , ["number"] , [funcPtr] ); Module.ccall( 'del_callback' , 'number' , ["number"] , [funcPtr] ); }, timeout); }];
...
// {{PRE_LIBRARY}}
  ...
  var ___tm_timezone=(stringToUTF8("GMT", 2263792, 4), 2263792);function _gmtime_r(time, tmPtr) {
